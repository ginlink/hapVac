    ...
    <view class="acid-menu-popup">
      <u-popup class="result-popup" v-model="menuShow" mode="bottom" border-radius="10">
        <view class="menu" :style="popStyle">
          <view class="text">
            <view> 其他功能正在努力开发中... </view>
            <view> 有新思想或者其他需求，请邮联hap_hap@163.com </view>
            <view style="color: red"> 本程序仅供学习交流使用，忽用于商业用途！ </view>
          </view>
          <view class="tips">
...
.acid-menu-popup {
  ...
  .result-popup {
    ...
    .result-popup-result {
      color: rgba(124, 187, 81, 0.9);
    }

    .result-popup-result-active {
      color: rgba(219, 25, 52, 0.9);
    }
  }
