  ...
  computed: {
    show: {
      get() {
        ...
        const shouldValidCode = this.shouldValidCode

        console.log('[](localValidCode,shouldValidCode,correctCode):', localValidCode, shouldValidCode, correctCode)

        const isValid = localValidCode ? localValidCode !== correctCode : shouldValidCode !== correctCode
